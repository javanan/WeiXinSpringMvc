...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="f"%>
		...
		<div class="top">
			<span class="logo">&nbsp;</span><span style="width:40px;">&nbsp;</span><b>后台管理中心</b>&nbsp;&nbsp;&nbsp;&nbsp;
			您好，<a href="${pageContext.request.contextPath}/admin/showMyInfo/0">${adminInfo.wadName}</a>
		...
		<div class="nav" id="adminTop">
			<c:forEach var="menu1" items="${adminMenusLevel1}">
			<c:set var="menu1Class" value=""></c:set>
			<c:if test="${menu1.WME_ID == adminMenuId1}">
		...
		<div class="admin_left" id="adminLeft">
			...
			<ul class="menu" id="${menu1.WME_ID }" ${menu1Display }>
				<c:forEach var="menu2" items="${adminMenusLevel2}">
