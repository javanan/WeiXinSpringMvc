...
public class WeixinController {
	...
	public String queryAccessToken(@ModelAttribute("command") LzWeiAccesstoken token, Model model) throws Exception {
		...
		if (tokenCur != null) {
			model.addAttribute(SysConstant.ACCESSTOKEN_EXPIRE, DateUtil.parseString(
					DateUtil.parseDate(tokenCur.getWatExpiresIn(), "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss"));
	...
	public String queryAccessToken1(@ModelAttribute("command") LzWeiAccesstoken token, @PathVariable Integer wecId,
	...
	public String queryWatcherByEnter(@ModelAttribute("command") LzWeiWatcher watcher, @PathVariable Integer wecId,
			Model model) {
	...
	public String toSendWeixin(@ModelAttribute("command") LzWeiWatcher watcher, @PathVariable Integer wacId,
			Model model) {
	...
	public String setAccessToken(@ModelAttribute("command") LzWeiAccesstoken accesstoken,
	...
	public String updateWatcherOnline(@ModelAttribute("command") LzWeiWatcher watcher, HttpSession session,
		...
		do {
			nextOpenId = (String) session.getAttribute("curNextOpenId") == null ? ""
					: (String) session.getAttribute("curNextOpenId");
	...
	public String queryWeixinEnterByE(@ModelAttribute("command") LzWeiEnter weiEnter, @PathVariable Integer wcsId,
			Model model) {
	...
	public String addWeiEnter(@ModelAttribute("command") LzWeiEnter weiEnter, HttpSession session,
			RedirectAttributes redirectAttributes) {
		// 查重
	...
	public String delWeiEnter(@ModelAttribute("command") LzWeiEnter weiEnter, HttpServletRequest request,
			RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("formHidden",
				StringUtil.formGet(request.getContextPath() + "/weixin/queryWeixinEnter"));
	...
	public String toUpdWeiEnter(@ModelAttribute("command") LzWeiEnter weiEnter_Q, Model model)
		...
		// LzCustomerEnterprise enter =
		// webuserservice.getCustEnteById(weiEnter.getWecEnterId());
		// if(enter!=null)
		// {
	...
	public String updWeiEnter(@ModelAttribute("command") LzWeiEnter weiEnter, HttpServletRequest request,
	...
	public String toAddWeiEnterByE(@ModelAttribute("command") LzWeiEnter weiEnter, @PathVariable Integer enterId,
			Model model) {
	...
	public String addWeiEnterByE(@ModelAttribute("command") LzWeiEnter weiEnter, @PathVariable Integer enterId,
	...
	public String delWeiEnter(@ModelAttribute("command") LzWeiEnter weiEnter, @PathVariable Integer enterId,
		...
		redirectAttributes.addFlashAttribute("alertMsg", "删除成功");
		redirectAttributes.addFlashAttribute("formHidden",
				StringUtil.formGet(request.getContextPath() + "/weixin/queryWeixinEnterBySite/" + enterId));
		return "redirect:/admin/toMsg";
	}
	...
	public String updWeiEnterByE(@ModelAttribute("command") LzWeiEnter weiEnter, @PathVariable Integer enterId,
	...
	public String queryJsApiTicket(@ModelAttribute("command") LzWeiJsapiTicket ticket, Model model) throws Exception {
		...
		if (ticketCur != null) {
			model.addAttribute(SysConstant.JS_API_TICKET_EXPIRE, DateUtil.parseString(
					DateUtil.parseDate(ticketCur.getWjtExpiresIn(), "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss"));
	...
	public String setJsApiTicket(@ModelAttribute("command") LzWeiJsapiTicket ticket,
			RedirectAttributes redirectattributes) {
		try {
